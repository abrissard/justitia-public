...
export const initialQuestions: string[] = [
    "What data of mine is being collected on Zotero?",
    "How is my data being used on Udemy?",
    "How is my data protected on Yousician?",
    "What are my rights as a user on USAToday?",
    "What happens if I violate terms on WhatsApp?",
]
